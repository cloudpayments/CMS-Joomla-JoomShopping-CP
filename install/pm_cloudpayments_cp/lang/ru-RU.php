...
define("SALE_HPS_CLOUDPAYMENT_calculationPlace", "Место осуществления расчёта");
define("SALE_HPS_CLOUDPAYMENT_calculationPlace_DESC", "Адрес сайта точки продаж, для печати в чеке");
...
define("SALE_HPS_CLOUDPAYMENT_WIDGET_SKIN", "Дизайн виджета");
...
define("DELIVERY_VAT1", "НДС 10%");
define("DELIVERY_VAT2", "НДС 20%");
...
define("SALE_HPS_NDS_2", "НДС 20%");
define("SALE_HPS_NDS_3", "НДС 0%");
define("SALE_HPS_NDS_4", "расчетный НДС 10/110");
define("SALE_HPS_NDS_5", "расчетный НДС 20/120");
define("SALE_HPS_CLOUDPAYMENT_KASSA_METHOD", "Способ расчета");
define("SALE_HPS_CLOUDPAYMENT_KASSA_OBJECT", "Предмет расчета");
define("SALE_HPS_CLOUDPAYMENT_SHOP_AUTH_DESC", " При авторизации заказа статус меняется на");
